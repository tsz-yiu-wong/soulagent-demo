...
(function(global) {
  ...
  const FALLBACK_TODOS = [
    ...
    {
      id: 'todo_11',
      title: '完成上月教学常规自查表与教案月检归档',
      dueDate: getRelativeDateStr(-2),
      dueTime: '16:00',
      category: 'admin',
      completed: true,
      completedAt: getRelativeDateStr(-2) + ' 15:40',
      flagged: false,
