  ...
  return `
    <div class="memory-panel">
      ...
      <div class="memory-grid">
        ${memories.length > 0 ? memoryCardsHtml : '<div style="grid-column:1/-1;text-align:center;padding:60px 0;color:var(--text-muted);font-size:14px;">暂无已被记录的智能体记忆</div>'}
      </div>
    </div>
  `;
}
...
function clearAllProfileMemories() {
  if (confirm('确认清空该智能体所有的记忆积累吗？此操作无法撤销。')) {
