    ...
    <div class="chat-dialog-view">
      ...
      <div class="dialog-bottom-input">
        <div class="input-card" style="border-radius: 16px; padding: 12px 14px;">
          <textarea class="chat-textarea" id="dialog-chat-input" style="min-height: 48px; max-height: 120px;" placeholder="给 ${dialogExp ? escapeHtml(dialogExp.name) + '的AI分身' : escapeHtml(state.currentAgent)} 发送消息..."></textarea>
